...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<?php  
		if(isset($_REQUEST["name"])&&isset($_REQUEST["section"])&&isset($_REQUEST["CreditNum"])&&isset($_REQUEST["CreditCa"])&&($_REQUEST["name"]!="")&&($_REQUEST["CreditNum"]!=""))
		{
		?>
		<h1>Thanks, sucker!</h1>
		<?php
			 $name= $_REQUEST["name"];
			  $section = $_REQUEST["section"];
			   $Creditnumber= $_REQUEST["CreditNum"];
			   $Credittype=$_REQUEST["CreditCa"];
